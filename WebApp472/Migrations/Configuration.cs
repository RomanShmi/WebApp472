namespace WebApp472.Migrations
{
    ...
    using System.Linq;
    using WebApp472.Models;

    internal sealed class Configuration : DbMigrationsConfiguration<WebApp472.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(WebApp472.Models.ApplicationDbContext context)
        { CreateStates(context);       }

        public void CreateStates(ApplicationDbContext context)
        {
            foreach (var state in SeedState)
            {
        ...
        private static List<State> SeedState = new List<State>
        {
